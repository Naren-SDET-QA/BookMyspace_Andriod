// release/v1.0 version of notifications_screen.dart, kept alongside the
...
class NotificationsScreenV1 extends ConsumerWidget {
  const NotificationsScreenV1({super.key});
...
class _NotificationTile extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final iconData = _iconForType(notification.kind);
    final iconColor = _colorForType(notification.kind);
    return Card(
