// release/v1.0 version of my_bookings_screen.dart, kept alongside the
...
class MyBookingsScreenV1 extends ConsumerStatefulWidget {
  const MyBookingsScreenV1({super.key});

  @override
  ConsumerState<MyBookingsScreenV1> createState() => _MyBookingsScreenState();
}

class _MyBookingsScreenState extends ConsumerState<MyBookingsScreenV1> {
  int _selectedTab = 0;
                            ...
                            itemBuilder: (context, i) => Padding(
                              ...
                              child: _BookingCard(
                                ...
                                onPay:
                                    ...
                                    ? () => context.push(
                                        AppRoutes.v1PaymentFlow.replaceFirst(
                                          ':id',
                                          filtered[i].id,
                                        ),
                                        extra: filtered[i],
                                ...
                                onBookAgain: filtered[i].canBookAgain
                                    ? () => context.push(
                                        AppRoutes.v1VenueDetails.replaceFirst(
                                          ':id',
                                          filtered[i].venueId,
                                        ),
                                      )
