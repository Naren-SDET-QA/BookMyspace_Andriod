// release/v1.0 version of search_screen.dart, kept alongside the
...
class SearchScreenV1 extends ConsumerStatefulWidget {
  const SearchScreenV1({
    super.key,
  ...
  @override
  ConsumerState<SearchScreenV1> createState() => _SearchScreenState();
}

class _SearchScreenState extends ConsumerState<SearchScreenV1> {
