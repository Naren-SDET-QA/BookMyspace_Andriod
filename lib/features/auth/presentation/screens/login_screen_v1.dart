// release/v1.0 version of login_screen.dart, kept alongside the
...
class LoginScreenV1 extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LoginScreenV1> createState() => _LoginScreenState();
}

enum _OtpChannel { email, phone }

class _LoginScreenState extends ConsumerState<LoginScreenV1> {
