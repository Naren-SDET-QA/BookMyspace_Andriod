// release/v1.0 version of create_venue_screen.dart, kept alongside the
...
class CreateVenueScreenV1 extends ConsumerStatefulWidget {
  const CreateVenueScreenV1({super.key, this.venueId});
  ...
  @override
  ConsumerState<CreateVenueScreenV1> createState() => _CreateVenueScreenState();
}

class _CreateVenueScreenState extends ConsumerState<CreateVenueScreenV1> {
