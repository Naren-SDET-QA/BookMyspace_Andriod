// release/v1.0 version of owner_registration_screen.dart, kept alongside the
...
class OwnerRegistrationScreenV1 extends ConsumerStatefulWidget {
  const OwnerRegistrationScreenV1({super.key});

  @override
  ConsumerState<OwnerRegistrationScreenV1> createState() =>
      _OwnerRegistrationScreenState();
}

class _OwnerRegistrationScreenState
    extends ConsumerState<OwnerRegistrationScreenV1> {
