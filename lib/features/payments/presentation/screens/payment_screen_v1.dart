// release/v1.0 version of payment_screen.dart, kept alongside the
...
class PaymentScreenV1 extends ConsumerStatefulWidget {
  const PaymentScreenV1({super.key, required this.booking});

  final Booking booking;

  @override
  ConsumerState<PaymentScreenV1> createState() => _PaymentScreenState();
}
...
class _PaymentScreenState extends ConsumerState<PaymentScreenV1> {
