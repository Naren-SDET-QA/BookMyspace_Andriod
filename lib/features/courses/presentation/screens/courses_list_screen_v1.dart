// release/v1.0 version of courses_list_screen.dart, kept alongside the
...
class CoursesListScreenV1 extends ConsumerStatefulWidget {
  const CoursesListScreenV1({super.key});

  @override
  ConsumerState<CoursesListScreenV1> createState() => _CoursesListScreenState();
}

class _CoursesListScreenState extends ConsumerState<CoursesListScreenV1> {
