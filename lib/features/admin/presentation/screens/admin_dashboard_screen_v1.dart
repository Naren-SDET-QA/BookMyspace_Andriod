// release/v1.0 version of admin_dashboard_screen.dart, kept alongside the
...
class AdminDashboardScreenV1 extends ConsumerWidget {
  const AdminDashboardScreenV1({super.key});
